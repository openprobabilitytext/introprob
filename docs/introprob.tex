...
\urlstyle{same}
\hypersetup{
  pdftitle={Introduction to Probabiity},
  pdfauthor={Madhuka and Rajinda},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Introduction to Probabiity}
...
\hypertarget{counting-combinations-and-permutations}{%
\chapter{Counting, Combinations, and Permutations}\label{counting-combinations-and-permutations}}
